function [results]=find_dead_ends_and_blocked(model)
    ...
    %
    % Dependancies
    %   this code uses FVA, doi:10.1186/1471-2105-11-489, available from
    ...
    switch lower(model.description)
        ...
        case {'yeast_6.06_cobra'}
            %note: Y6 includes the Y6 biomass def (rxn r_2133, with
            %lb=ub=0), and the Y5 biomass def (r_2110, with lb=0, ub=1000).
            %Both include the same lipid species, s_1096, made in reaction
            %r_2108. Below, I select the Y5 biomass def, then modify it as
            %for Y5.
            
            changed_model = model;
            changed_model.ub(findRxnIDs(model,'r_2110')) = 1000;
            changed_model.ub(findRxnIDs(model,'r_2133')) = 0;
        ...
        case {'yeast_7.00_cobra'}
            ...
            %lb=ub=0), and the Y5 biomass def (r_2110, with lb=0, ub=1000).
            %Both include the same lipid species, s_1096, made in reaction
            %r_2108. Below, I select the Y6 biomass def, then modify it as
            %for Y6.
            ...
            changed_model=changeRxnMets(changed_model,...
                {'s_0002';'s_0423';'s_0434';'s_0526';'s_0584';...
                's_0589';'s_0615';'s_0649';'s_0773';'s_0782';'s_0803';...
                's_0955';'s_0965';'s_0969';'s_0973';'s_0981';'s_0991';...
                's_0999';'s_1003';'s_1006';'s_1016';'s_1021';'s_1025';...
                ...
                's_0973';'s_0981';'s_0991';'s_0999';'s_1006';'s_1016';...
                's_1021';'s_1025';'s_1029';'s_1032';'s_1035';'s_1039';...
                's_1045';'s_1048';'s_1051';'s_1056';'s_1107';'s_2954';...
                's_1346';'s_1351';'s_1337';'s_1467';'s_1524';'s_1545';...
                's_1569';'s_0394';'s_0450';'s_1322';}, ... %new mets -Y7 doesn't have phosphatidate [cytoplasm] (met 1190, s_1331), use s_2954 instead
                {'r_2133';}, ... %rxn id
                [-1.1348;-0.0053;-0.0234;-0.046;-59.276;-0.0447;...
                -0.0036;-0.0024;-0.0024;-0.0036;-0.0007;-0.2904;...
                -0.5185;-0.046;-0.4588;-0.1607;-0.1017;-0.2975;...
...
function blockedReactions = findBlockedReaction_ks(model)
    ...
    % Ben Heavner: use FVA instead 12/11/13
...
%    [minMax(:,1),minMax(:,2)] = fluxVariability(model,0); %this has unpredictable errors...
    ...
    if strcmpi(model.description, 'iTO977_cobra_compatible')
        try
            rxnNameList = model.rxns(~strcmp(model.rxns,'GIT1_1')); % if this reaction doesn't carry flux, matlab hangs
            [minMax(:,1),minMax(:,2)] = fluxVariability(model,0,'max',rxnNameList); %this has unpredictable errors...
        catch
            error(fva:fvafailed, 'flux variability analysis failed');
        end
    else
        try
            [minMax(:,1),minMax(:,2)] = fastFVA(model,0); % this doesn't work in all cases
        catch
            try
                warning('fastFVA failed, trying fluxVariability');
                [minMax(:,1),minMax(:,2)] = fluxVariability(model,0); %this has unpredictable errors...
            catch
                error(fva:fvafailed, 'flux variability analysis failed');
            end
