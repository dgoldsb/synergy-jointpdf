...
lahdesmaki2003learning
indegree yeast 2-3, low in gerenal, 4-8 in more complicated networks
indegree of each gene low
seems simple relations mostly

schlitt2007current
pbn
seems only + or - single, but with strerngth
