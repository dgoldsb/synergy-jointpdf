...
This would allow us to do multiple time steps reliably, and to better represent large gene regulatory networks when measuring synergy and memory. % BECAUSE, this is important, our measurements involve a time step
